package com.objlove.util.enums;
...
public enum HttpStatusCode {
    ...
    public boolean is2xxinformational() {
        return type() == SUCCESSFUL;
    }

    public boolean is3xxinformational() {
        return type() == REDIRECTION;
    }

    public boolean is4xxinformational() {
        return type() == CLIENT_ERROR;
    }

    public boolean is5xxinformational() {
    ...
    public static void main(String[] args) {
        System.out.println(HttpStatusCode.OK.getCode());
    }
}
